...
<div class="card bg-white border-0 rounded-3 mb-4">
  ...
  <i class="material-symbols-outlined position-absolute top-50 start-0 translate-middle-y text-secondary">search</i>
            ...
            <button class="btn btn-outline-primary fw-medium rounded-3 hover-bg" data-bs-toggle="modal" data-bs-target="#exampleModal2">
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 550px;">
                <div class="modal-content rounded-0">
                    <div class="modal-header border-0 p-4 border-bottom">
                        <h1 class="modal-title fs-18" id="exampleModal2Label">Thêm mới</h1>
...
export default defineComponent({
    setup() {
        ...
        const getPackage = () => {
            ...
            axios
                .get(`${baseUrl}/api/packages`, { params })
                .then((response) => {
