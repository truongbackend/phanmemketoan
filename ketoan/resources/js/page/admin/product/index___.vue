...
<div class="card bg-white border-0 rounded-3 mb-4">
    <div class="card-body p-25">
        ...
        <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" style="max-width: 1045px;">
...
<div v-for="(item, index) in comboItems" :key="index" class="row align-items-end mb-3">
    <div class="col-lg-3">
        <div class="form-group">
    ...
    <div class="col-lg-2">
        <div class="form-group">
            <label class="label text-secondary">Đơn vị tính</label>
            <input v-model="combo_unit" type="text" class="form-control h-60 border-border-color" placeholder="Đơn vị tính ...">
        </div>
    </div>
    <div class="col-lg-2">
        <div class="form-group">
            <label class="label text-secondary">Số lượng</label>
            <input v-model="quantity" type="number" class="form-control h-60 border-border-color" placeholder="Số lượng ...">
        </div>
    </div>
    <div class="col-lg-2 d-flex align-items-center">
        <button class="btn btn-danger btn-sm mt-4" type="button" @click="removeComboItem(index)" v-if="comboItems.length > 1">Xoá</button>
    </div>
</div>
<button type="button" class="btn btn-outline-primary btn-sm mb-3" @click="addComboItem">+ Thêm dòng combo</button>
...
export default defineComponent({
    setup() {
        ...
        const removeComboItem = (index) => {
            if (comboItems.value.length > 1) {
                comboItems.value.splice(index, 1);
            }
        };
    ...
    combo_items: comboItems.value,
                ...
                .then(() => {
                    ...
                    unit.value = '';
                    tax_rate.value = null;
                    comboItems.value = response.data.combo_items || [{
                    combo_detail_code: '',
                    combo_name: '',
                    combo_unit: '',
                    quantity: null
