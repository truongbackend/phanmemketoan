...
<div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
    <h3 class="mb-0">Kết nối sàn Shopee</h3>
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb align-items-center mb-0 lh-1">
            ...
            <li class="breadcrumb-item active" aria-current="page">
                <span class="fw-medium">Shopee</span>
            </li>
            <li class="breadcrumb-item active" aria-current="page">
    ...
    <div class="card border-0 bg-white" style="height: 700px; margin: auto;">
        <div class="card-body p-4 py-5 p-xl-5 text-center" v-if="!accountShop.length">
            <h2 class="fs-24 fw-semibold mb-2">Bạn đang bán hàng trên kênh Shoppe</h2>
                                        ...
                                        <li class="d-flex align-items-center justify-content-between mb-2 pb-2">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/assets/avatar/shopee.png" width="40px" class="rounded-circle" />
                                                </div>
                                                <div class="flex-grow-1 ms-2">
                                                    <h6 class="fw-medium fs16 mb-0">Shopee</h6>
